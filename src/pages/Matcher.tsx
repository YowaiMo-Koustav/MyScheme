...
import { ArrowRight, ArrowLeft, SkipForward, CheckCircle, Loader2, Shield } from 'lucide-react';
      ...
      <div className="min-h-screen gradient-hero flex items-center justify-center">
        ...
        >
          <motion.div
            ...
            className="w-20 h-20 mx-auto mb-8 rounded-2xl gradient-accent flex items-center justify-center"
          >
          ...
          <p className="text-white/60 mb-8">Scanning 2,500+ schemes to find your best matches</p>
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-2xl">
          <AnimatePresence mode="wait">
            ...
            >
              <h2 className="text-2xl md:text-4xl font-display font-extrabold text-foreground mb-8 text-center text-balance">
                {currentQ.question}
              </h2>
              ...
              {currentQ.type === 'number' && (
                <div className="max-w-xs mx-auto">
                  <Input
                    ...
                    className="text-center text-2xl py-6 rounded-xl"
                    min={1}
                    max={120}
                    onKeyDown={(e) => {
                      if (e.key === 'Enter') {
                  ...
                  />
                  <Button
                    className="w-full mt-4 gradient-primary text-primary-foreground py-6 rounded-xl"
                    onClick={() => {
          ...
          <div className="flex items-center justify-between mt-10">
            ...
            {currentQ.sensitive && (
              <Button variant="ghost" onClick={handleSkip} className="text-muted-foreground">
                ...
                {currentQ.skip_text && (
                  <span className="hidden md:inline text-xs ml-1 opacity-60">({currentQ.skip_text})</span>
                )}
              </Button>
            )}
          </div>
